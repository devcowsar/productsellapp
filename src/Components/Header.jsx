      ...
      <nav className="bg-white border-gray-200 py-7 lg:px-6 px-5 dark:bg-gray-900">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          <a href="#" className="flex items-center">
            <img
              src={logo}
              className="h-[30px] lg:h-[47px]  mr-3 sm:h-9"
              alt="EyeGlass Logo"
            />
          </a>
          <div className="flex items-center justify-between lg:order-2">
            ...
            <div>
              <a href="#">
                <button className="text-xl text-heading-text mt-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li className="text-xl">
                <a
                  href="#"
                  className="block py-2 pl-3 pr-4 text-heading-text  font-normal bg-purple-700 rounded lg:bg-transparent lg:p-0 dark:text-white"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li className="text-xl">
                <a
                  href="#"
                  className="block py-2 pl-3 pr-4 text-heading-text  font-normal border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                >
                  About Us
                </a>
              </li>
